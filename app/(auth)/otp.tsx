...
const Otp = () => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            <View className="flex p-12 justify-between relative">
                <TouchableOpacity className="absolute right-5 top-3">
                    <Text className="text-blue-500 text-sm">Tiếp</Text>
                </TouchableOpacity>

                <Text className="text-2xl font-bold text-center mb-3">Xác nhận Mã OTP</Text>
                ...
                <Text className="text-center text-base text-black mb-2">Nhập mã để tiếp tục</Text>
